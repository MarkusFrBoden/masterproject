...
export function EUcalculation(
    ...
    if (dmaDetails.value && dmaDetails.value.responses && dmaDetails.value.responses.length > 0) {
        ...
        if (dmaDetails.value.responses[0].data.EUPSOQuestion1) {
        ...
        //EU-Results calculation SME
        else if (dmaDetails.value.responses[0].data.EUSMEQuestion1) {

            let D1countColumn1 = 0;
            let D1countColumn2 = 0;
            if (responses[0].data.EUSMEQuestion15) {
                const question15 = responses[0].data.EUSMEQuestion15;
            ...
            if (responses[0].data.EUSMEQuestion16) {
                question16value = responses[0].data.EUSMEQuestion16.length;
            }
            let dim1 = question16value * 3.333333333333333333 + D1countColumn1 * 3.333333333333333333 + D1countColumn2 * 3.333333333333333333;

            //Dimension 2 (17-18)
            let question17value = 0
            if (responses[0].data.EUSMEQuestion17) {
                question17value = responses[0].data.EUSMEQuestion17.length;
            }
            const itemCounts: any = {
                "Item 2": 0,
                "Item 3": 0,
            ...
            if (responses[0].data.EUSMEQuestion18) {
                const question18 = responses[0].data.EUSMEQuestion18;
                for (const row in question18) {
                    if (Object.prototype.hasOwnProperty.call(question18, row)) {
                        const item = question18[row]["Column 1"];
                        if (itemCounts.hasOwnProperty(item)) {
            ...
            //Dimension3 (19-20)
            let question19value = 0
            if (responses[0].data.EUSMEQuestion19) {
                question19value = responses[0].data.EUSMEQuestion19.length;
            }
            let question20value = 0
            if (responses[0].data.EUSMEQuestion20) {
                question20value = responses[0].data.EUSMEQuestion20.length;
            }
            let dim3 = ((question19value / 7) * 10 + (question20value / 8) * 10) * 5

            //Dimension4 (21-22)
            let question21value = 0
            if (responses[0].data.EUSMEQuestion21) {
                question21value = responses[0].data.EUSMEQuestion21.length;
            }
            let question22value = 0
            if (responses[0].data.EUSMEQuestion22) {
                question22value = responses[0].data.EUSMEQuestion22.length;
            }
            ...
            if (responses[0].data.EUSMEQuestion23) {
                const question18 = responses[0].data.EUSMEQuestion23;
                for (const row in question18) {
                    if (Object.prototype.hasOwnProperty.call(question18, row)) {
                        const item = question18[row]["Column 1"];
            ...
            //Dimension 6 (24-25)
            let question24value = 0
            if (responses[0].data.EUSMEQuestion24) {
                question24value = responses[0].data.EUSMEQuestion24.length;
            }
            let D6countColumn1 = 0;
            let D6countColumn2 = 0;
            let D6countColumn3 = 0;
            if (responses[0].data.EUSMEQuestion25) {
                const question25 = responses[0].data.EUSMEQuestion25;
                for (const key in question25) {
                    const value = question25[key];
                    if (value === "Column 1") {
                        D6countColumn1++;
